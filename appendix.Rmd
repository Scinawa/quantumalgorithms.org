...
```{theorem, ljapunov, name="Bernoulli inequalities, [From here](https://en.wikipedia.org/wiki/Bernoulli%27s_inequality#Related_inequalities)"}

- Bernoulli inequality:  for $\forall n \in \mathbb{N}, x\geq -1$ $$(1+x)^n \geq 1+nx$$ (check what happens if $n$ even or odd)
...
- Session cookies: used only for the purpose of authenticating a User.
