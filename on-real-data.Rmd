...
header-includes:
    - \usepackage{subfig}
description: "Quantum machine learning experiments. Lecture notes on quantum experiments in machine learning. Quantum simulation of machine learning algorithms"
...
### QPCA
These experiment are extracted from a M.Sc. thesis [@bellante2020quantum] and from a soon-to-appear work.
This section shows several experiments on the MNIST, Fashion MNIST, CIFAR-10 and Research Papers datasets.
