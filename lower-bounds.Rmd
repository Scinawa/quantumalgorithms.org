...
(ref:paturi1992degbound) [@paturi1992degbound]

```{theorem, paturi-theorem, name="Paturi theorem (ref:paturi1992degbound)"}
...
(ref:markov1890ineq) [@markov1890ineq]

```{theorem, markov-brothers-ineq, name="Markov brothers' inequality (ref:markov1890ineq)"}
...
(ref:ambainis2002adversary) [@ambainis2002adversary]

```{theorem, basic-adversary, name="Basic Adversary Method (ref:ambainis2002adversary)"}
