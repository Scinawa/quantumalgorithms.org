...
In this section, we report two lemmas that can be used to estimate the inner products, distances, and quadratic forms between vectors. The lemma \ref{th:innerproductestimation} has been developed in the work \cite{kerenidis2019qmeans,luongo2019spectral}. 
