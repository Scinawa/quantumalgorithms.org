...
reader is highly encouraged to skim the appendix on his/her own, so to
...
In the whole book, we use a standard notation of $\widetilde{O}$ for hiding polylogarithmic
