...
Where we used Postulate \@ref(prp:postulate3) with the observable $\ket{0}\bra{0}\otimes I$.The probability of measuring $1$ in the first register follows trivially. 
